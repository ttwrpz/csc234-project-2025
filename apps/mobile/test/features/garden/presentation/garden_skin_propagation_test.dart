...
void main() {
  group(
    'GardenBed — TC-6 current-week sunflower skin propagation',
    () {
      ...
      testWidgets(
        ...
        (tester) async {
          ...
          expect(
            find.bySemanticsLabel(RegExp(r'sunflower')),
            findsOneWidget,
          );
        },
      );
      ...
      testWidgets(
        ...
        (tester) async {
          ...
          expect(
            bed.speciesAccent![FlowerSpecies.lavender],
            lavenderAccent,
          );
          ...
          expect(
            bed.speciesAccent!.containsKey(FlowerSpecies.daisy),
            isFalse,
          );
          expect(
            bed.speciesAccent!.containsKey(FlowerSpecies.fern),
            isFalse,
          );
        },
      );
