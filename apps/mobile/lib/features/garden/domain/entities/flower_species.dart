...
/// history list, the garden's "Recent moods" preview, and the weekly-
/// harvest summary surfaces.
///
/// The mapping from `MoodType` is intentionally fixed: each mood owns a
