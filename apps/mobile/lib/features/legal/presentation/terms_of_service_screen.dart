...
/// Settings > About > Terms of service. The content is exposed as
/// [document] so the sign-in / sign-up overlays render the same source.
class TermsOfServiceScreen extends StatelessWidget {
  const TermsOfServiceScreen({super.key});

  @override
  Widget build(BuildContext context) =>
      const LegalDocumentScreen(document: document);

  static const LegalDocument document = LegalDocument(
