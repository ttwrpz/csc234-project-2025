...
@override
String toString() {
  return 'SignInState(email: $email, password: $password, isSubmitting: $isSubmitting, errorMessage: $errorMessage)';
}
...
class _SignInState implements SignInState {
  const _SignInState({this.email = '', this.password = '', this.isSubmitting = false, this.errorMessage});
