...
///
/// Every Tier 3 [Quote] in the wild has `source == QuoteSource.curated` -
/// Tier 3 never calls Gemini. Tests assert this invariant.
...
/// dispatcher's responsibility, not the library's.
@freezed
