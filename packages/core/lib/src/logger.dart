...
///
/// Crashlytics integration lands in Sprint 3. PII redaction is the *call
/// site's* responsibility (per CLAUDE.md): never pass `entry.text`, raw email,
/// or `userId + text` correlations to any of these methods.
class Logger {
